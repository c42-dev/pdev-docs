...
Para mover saldo entre carteiras fora de um pagamento, continua existindo a transferência interna — operação explícita, feita no Dashboard, que não fica pendurada na liquidação de uma cobrança.
